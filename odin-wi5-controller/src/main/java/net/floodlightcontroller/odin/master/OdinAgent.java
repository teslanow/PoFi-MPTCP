...
class OdinAgent implements IOdinAgent {
	...
	public ConcurrentSkipListSet<OdinClient> mpClientList = new ConcurrentSkipListSet<OdinClient>();
	...
	private static final String WRITE_HANDLER_ADD_MVAP = "add_mvap";
	private static final String WRITE_HANDLER_REMOVE_MVAP = "remove_mvap";
	...
	public void removeClientMvap(OdinClient oc) {
		invokeWriteHandler(WRITE_HANDLER_REMOVE_MVAP, oc.getMacAddress()
				.toString());
		mpClientList.remove(oc);
	}

	/**
	 * Add a virtual mptcp access point to the AP corresponding to this agent
	 *
	 * @param oc OdinClient entity
	 */
	public void addClientMvap(OdinClient oc) {
		...
		invokeWriteHandler(WRITE_HANDLER_ADD_MVAP, oc.getMacAddress().toString()
